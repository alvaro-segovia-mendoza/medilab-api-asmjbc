package org.alixar.daw2.alvarosegovia.dwese2526_medilab_api_alvarosegovia.dto.common;
...
public class ApiErrorDTO {
    ...
    /** Código estable de negocio para clientes REST. No depende del idioma. */
    private String code;
    ...
    /** Ruta del endpoint que provocó el error (ej. "/api/tecnicos/10"). */
    private String path;


    /** Recurso afectado (ej. "tecnico", "user"). Útil en errores semánticos. */
     ...
     * </p>
     */
    public static ApiErrorDTO basic(int status, String error, String code, String message, String path) {
     ...
     * <p>
     * Casos típicos:
     * - 404 Not Found (resource="tecnico", field="id", value=99)
     * - 409 Conflict por duplicidad (resource="tecnico", field="code", value="AND")
     * - 400 Bad Request semántico (ej. fichero inválido)
     * </p>
     */
    public static ApiErrorDTO withContext(int status, String error, String code, String message, String path,
     ...
     * </p>
     */
    public static ApiErrorDTO validation(String error, String code, String message, String path, Map<String, String> fieldErrors) {
